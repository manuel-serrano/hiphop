...
//
const KEYWORDS = /(\d|^)(signal|immediate|pre|value|not|apply|countValue|countApply|res|susp|kill|ifApply|ifValue|id|from|fromValue|fromApply|to|toValue|toApply|toggleSignal|toggleValue|toggleApply|emitWhenSuspended|noDebug|name)(\s|$)/i;
