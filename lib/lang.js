...
/*    Last change :  Wed Aug  1 12:54:02 2018 (serrano)                */
...
function checkChildren( tag, attrs, args, min, max ) {
   ...
   if( children.length < min || (max > -1 && children.length > max) ) {
	 ...
	 msg += "max " + max;
      ...
      throw new SyntaxError( tag + ": " + msg, attrsLoc( attrs ) ); 
   }
...
function RUN( attrs={}, ...nodes ) {
   ...
   if( !attrs.module || !(attrs.module instanceof ast.Module) )
      throw new SyntaxError( "RUN: module must be a Hiphop.js module", loc );
...
function EXEC( attrs={}, ...nodes ) {
   ...
   if (attrs.res && !(attrs.res instanceof Function))
      throw new TypeError( "Function", typeof attrs.res, attrsLoc( attrs ) );

   if (attrs.susp && !(attrs.susp instanceof Function))
      throw new TypeError( "Function", typeof attrs.susp, attrsLoc( attrs ) );

   if (attrs.kill && !(attrs.kill instanceof Function))
      throw new TypeError( "Function", typeof attrs.kill, attrsLoc( attrs ) );
