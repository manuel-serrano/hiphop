...
/*    Last change :  Fri Jul 20 12:37:11 2018 (serrano)                */
...
function getArguments( tag, attrs, loc ) {
   ...
   args.immediate = hasFlag( "immediate" ) && raw.immediate !== false;
   args.pre = hasFlag( "pre" ) && raw.pre !== false;
...
function ABORT( attrs={}, ...nodes ) {
   ...
   var r = new ast.Abort( args.id, args.loc, args.nodebug, args.func,
			 args.accessor_list.concat( axs ), args.immediate,
			 args.func_count, args.accessor_list_count,
			  makeImplicitSequence( attrs, children ) );
   return r;
