...
function EXEC(attrs) {
   ...
   if (!attrs.start || !(attrs.start instanceof Function))
      throw new TypeError("Function", typeof attrs.start, loc);

   if (attrs.res && !(attrs.res instanceof Function))
      throw new TypeError("Function", typeof attrs.res, loc);

   if (attrs.susp && !(attrs.susp instanceof Function))
      throw new TypeError("Function", typeof attrs.susp, loc);

   if (attrs.kill && !(attrs.kill instanceof Function))
      throw new TypeError("Function", typeof attrs.kill, loc);

   return new ast.Exec(attrs.id, loc, attrs.signal, attrs.start,
		       make_accessors(attrs.start),
