...
function IF(attrs) {
   ...
   attrs = check_attributes(attrs, undefined, ["func", "arg", "not"]);
   check_expression_node(loc, attrs);
...
function PRESENT(attrs) {
   ...
   attrs = check_attributes(attrs, ["signal"], ["pre", "not"]);
   check_expression_node(loc, attrs);
   return new ast.If(attrs.id,
		     loc,
		     [children[0], children[1]],
...
function SUSPEND(attrs) {
   ...
   attrs = check_attributes(attrs, ["signal"], ["pre"]);
   check_expression_node(loc, attrs)
...
function LOOPEACH(attrs) {
   ...
   attrs = check_attributes(attrs, ["signal"], ["pre", "count"]);
   check_count_expression_node(loc, attrs);
