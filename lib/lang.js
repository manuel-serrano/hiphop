...
/*    Last change :  Thu Aug  2 12:24:32 2018 (serrano)                */
...
function getArgumentsExpressionNode( tag, attrs, loc, axs ) {
   ...
   args.accessor_list = args.accessor_list.concat( axs );
...
function getArgumentsCountExpressionNode( tag, attrs, axs, cntaxs ) {
   ...
   args.accessor_list_count = args.accessor_list_count.concat( cntaxs );
   return args;
}
...
function SUSTAIN( attrs={}, ...nodes ) {
   ...
   return new ast.Sustain( args.id, attrsLoc( attrs ), args.nodebug,
...
function ABORT( attrs={}, ...nodes ) {
   ...
   var r = new ast.Abort( attrs.id, attrsLoc( attrs ), args.nodebug, args.func,
			  args.accessor_list, args.immediate,
			  args.func_count,
			  args.accessor_list_count,
			  makeImplicitSequence( attrs, children ) );
...
function WEAKABORT( attrs={}, ...nodes ) {
   ...
   return new ast.WeakAbort( attrs.id, attrsLoc( attrs ), args.nodebug,
