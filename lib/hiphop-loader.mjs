/*=====================================================================*/
/*    serrano/prgm/project/hiphop/1.3.x/lib/hiphop-loader.mjs          */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Fri Nov 17 08:15:59 2023                          */
/*    Last change :  Sat Feb  3 10:14:31 2024 (serrano)                */
...
async function HHcompile(url) {
   ...
   const target = dirname(path) + "/._" + basename(path).replace(extensionsRegex, ".");
