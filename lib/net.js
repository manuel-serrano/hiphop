...
/*    Last change :  Fri Jan 17 07:21:24 2025 (serrano)                */
...
class SignalNet extends LogicalNet {
   ...
   constructor(ast_node, type, signame, accessibility, lvl, neutral) {
   ...
   toJS() {
	 ...
	 return `machine["${this.signame}"].emitted[${this.lvl}] || ${super.toJS()}`;
      } else {
	 return super.toJS();
      }
   }
