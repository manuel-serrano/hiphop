/*=====================================================================*/
/*    serrano/prgm/project/hiphop/1.3.x/lib/net.js                     */
/*    -------------------------------------------------------------    */
/*    Author      :  Colin Vidal, Manuel Serrano, Gerard Berry         */      
/*    Creation    :  Sun Sep  9 06:19:12 2018                          */
/*    Last change :  Mon Jan 15 11:51:10 2024 (serrano)                */
...
class Net {
   ...
   constructor(ast_node, type, debug_name, lvl) {
      ...
      this.debug_name = `${debug_name} [${ast_node.constructor.name}/${this.constructor.name}]:${lvl}/${ast_node.depth}`;
