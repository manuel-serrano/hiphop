...
/*    Last change :  Wed May 14 12:18:51 2025 (serrano)                */
...
class Net {
   ...
   dump() {
      const $ast = { ctor: this.ctor || this.astNode.ctor, loc: this.astNode.loc };
      const parent = this.getNonSweepedParent();
      const $parent = parent
	 ? { ctor: parent.ctor, loc: parent.loc }
	 : undefined;
