...
function RegisterNet(ast_node, type, debug_name, lvl) {
...
function LogicalNet(ast_node, type, debug_name, lvl, neutral) {
   Net.call(this, type, ast_node, debug_name, lvl);
...
exports.make_or = function(ast_node, type, debug_name, lvl) {
   return new LogicalNet(ast_node, type, debug_name, lvl, false);
}

exports.make_and = function(ast_node, type, debug_name, lvl) {
