...
// SignalExpressionNet
//
function SignalExpressionNet(ast_node, type, signal_name, debug_name, lvl) {
   ActionNet.call(this, ast_node, type, debug_name, lvl, ast_node.func,
		  ast_node.accessor_list);

   this.signal = compiler.get_signal_object(ast_node.machine, ast_node.loc,
					    signal_name);
   let max_lvl = lvl > this.signal.ast_node.depth ? this.signal.ast_node.depth : lvl;
   this.connect_to(this.signal.dependency_gate_list[max_lvl], FAN.DEP);
}
