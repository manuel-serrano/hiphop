...
/*    Last change :  Sun Jul 17 14:35:45 2022 (serrano)                */
...
/*    cwd ...                                                          */
/*---------------------------------------------------------------------*/
const cwd = hop.isServer ? process.cwd() : import.meta.url;
...
class Net {
   ...
   constructor(ast_node, type, debug_name, lvl) {
      ...
      this.debug_name = ast_node.loc.filename ? `[${debug_id}]:${ast_node.constructor.name}[${ast_node.loc.filename}:${ast_node.loc.pos}](${this.constructor.name})_${debug_name}:${lvl}/${ast_node.depth}`
      :`[${debug_id}]:${ast_node.constructor.name}(${this.constructor.name})_${debug_name}:${lvl}/${ast_node.depth}`;

      //console.log("DB=", this.debug_name);
