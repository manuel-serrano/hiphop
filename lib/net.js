...
/*    Last change :  Fri Dec 20 12:28:14 2024 (serrano)                */
...
class Net {
   ...
   propagate(knownList) {
      const trace = this.ast_node.machine.tracePropagation;
...
class RegisterNet extends Net {
   ...
   receive(value, _) {
      if (this.ast_node.machine.tracePropagation) {
...
class ActionNet extends LogicalNet {
   ...
   dump() {
	 ...
	 return s;
      ...
      return Object.assign(super.dump(), { action: pp(this.func) });
   }
