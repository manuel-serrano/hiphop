...
/*    Last change :  Wed May 29 11:42:58 2019 (serrano)                */
...
class Net {
   constructor( ast_node, type, debug_name, lvl ) {
      ...
      this.debug_name =
	 `[${debug_id}]:${ast_node.constructor.name}[${ast_node.loc.filename}:${ast_node.loc.pos}](${this.constructor.name})_${debug_name}:${lvl}/${ast_node.depth}`;
