...
/*    Last change :  Wed Dec  3 17:24:17 2025 (serrano)                */
...
class Net {
   ...
   dump() {
	 ...
	 ? `${this.debugName} [${this.astNode.ctor}:${this.lvl}/${this.astNode.depth}]`
	 : `${this.debugName} [${this.astNode.ctor}:${this.astNode.loc.pos}]`;
