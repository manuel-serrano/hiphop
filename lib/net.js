...
Net.prototype.propagate = function(knownList) {
   if (this.machine.trace_propagation) {
...
TestExpressionNet.prototype.receive = function(value, fromDep) {
   if(LogicalNet.prototype.receive.call(this, value, fromDep)) {
      if (this.value === true) {
...
SignalExpressionNet.prototype.receive = function(value, fromDep) {
   if(LogicalNet.prototype.receive.call(this, value, fromDep)) {
      if (this.value === true) {
...
//
// TODO: SignalInitNet are useless now and can be
// removed. SignalInitNet sites must be use an ActionNet instead.
//
// It does not create dependencies to signal anymore (it was a
// mistake, see in compiler.js how signal initialization works now for
// local and global scope creation).
//
