...
/*    Last change :  Tue May 28 18:04:16 2019 (serrano)                */
...
class Net {
   constructor( ast_node, type, debug_name, lvl ) {
      ...
      this.debug_name =
	 `${ast_node.constructor.name}[${ast_node.loc.filename}:${ast_node.loc.pos}[${debug_id++}]](${this.constructor.name})_${debug_name}:${lvl}/${ast_node.depth}`;
   ...
   dump() {
      ...
      this.fanout_list.forEach( function( fan ) {
	 console.log( "   " + fan.net.debug_name );
      } );
