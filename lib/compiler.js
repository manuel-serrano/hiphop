...
function make_parallel(ast_node, children_interface) {
   ...
   // for (let l = 0; l <= ast_node.depth; l++) {
   //    let action_k0 = new net.ActionNet(ast_node, ast.Parallel, "debug", l,
   // 					function() {
   // 					   console.log("K0", l, ast_node.loc)
   // 					}, []);
   //    let action_k1 = new net.ActionNet(ast_node, ast.Parallel, "debug", l,
   // 					function() {
   // 					   console.log("K1", l, ast_node.loc)
   // 					}, []);
   //    let action_k2 = new net.ActionNet(ast_node, ast.Parallel, "debug", l,
   // 					function() {
   // 					   console.log("K2", l, ast_node.loc)
   // 					}, []);

   //    if (k_matrix[0] && k_matrix[0][l])
   // 	 k_matrix[0][l].connect_to(action_k0, net.FAN.STD);

   //    if (k_matrix[1] && k_matrix[1][l])
   // 	 k_matrix[1][l].connect_to(action_k1, net.FAN.STD);

   //    if (k_matrix[2] && k_matrix[2][l])
   // 	 k_matrix[2][l].connect_to(action_k2, net.FAN.STD);
   // }
...
function make_loop(ast_node, child_interface) {
   ...
   child_interface.k_matrix[0][depth2].connect_to(go_list[depth1], net.FAN.STD);
