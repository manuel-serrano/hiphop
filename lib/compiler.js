...
/*    Last change :  Wed Dec 10 10:37:19 2025 (serrano)                */
...
function makeForkCircuit_new(env, astNode, childCircuits) {
   ...
   childCircuits.forEach((c, n, _) => {
      ...
      // DO NOT CONNECT OR-NOT gate with GO of parallel and SEL of child
   ...
   console.log("KM=", kMatrix[0].length, sync.kMatrix[0].length);
