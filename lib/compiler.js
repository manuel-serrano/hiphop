...
/*    Last change :  Wed Apr 20 18:18:42 2022 (serrano)                */
/*    Copyright   :  2018-22 Inria                                     */
/*    -------------------------------------------------------------    */
/*    HipHop compiler                                                  */
/*=====================================================================*/
"use strict";
...
ast.Atom.prototype.makeCircuit = function(env) {
   ...
   let func = frame ? function() { console.log("ICIzzzz", frame); atomFunc(frame) } : atomFunc;
...
function compile(machine, ast_node) {
   ...
   let { loc, size, signals, posFlag} = 
      causality.findCausalityErrorDeep( machine, true );
   if( size > 0 ) {
      console.log( `Warning: Potential causality cycle`);       
   } else if( size < 0 ) {
