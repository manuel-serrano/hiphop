...
function makePause(ast) {
   var wire1 = new net.Net(ast);
   var and1 = net.makeAnd(ast);
   var or1 = net.makeOr(ast);
   var and2 = net.makeAnd(ast);
   var reg = new net.Register(ast);
   var and3 = net.makeAnd(ast);
   var negkill = new net.Net(ast);
   ...
   return new Interface([or 1, wire1], and3, and1, negkill, reg, [and3, wire1]);
}
