...
/*    Last change :  Fri Feb 20 12:18:35 2026 (serrano)                */
...
const synchronizer = process.env.HIPHOP_
/*---------------------------------------------------------------------*/
/*    compiler ...                                                     */
/*---------------------------------------------------------------------*/
...
function compile(machine, astNode) {
   ...
   if (machine.loopUnroll) {
      ...
      if (machine.loopTrapUnroll && !machine.reincarnationTrap) {
   ...
   // console.log("JSON=", JSON.stringify(astNode.tojson()));
