...
/*    Last change :  Mon Mar  3 13:43:49 2025 (serrano)                */
...
/*    compiler ...                                                     */
/*---------------------------------------------------------------------*/
function compiler(astNode, circuitName) {
...
function makeForkCircuit(env, astNode, childCircuits) {
   switch (compiler(astNode, "makeForkCircuit")) {
...
function makeTrapCircuit(env, astNode, childCircuit) {
   switch (compiler(astNode, "makeTrapCircuit")) {
...
function makeExitCircuit(env, astNode) {
   switch (compiler(astNode, "makeExitCircuit")) {
      case "int":
...
function makeSequenceCircuit(env, astNode, childCircuits) {
   switch (compiler(astNode, "makeSequenceCircuit")) {
...
function makePauseCircuit(env, astNode) {
   switch (compiler(astNode, "makePauseCircuit")) {
      case "int":
...
function makeLoopCircuit(env, astNode, childCircuits) {
   switch (compiler(astNode, "makeLoopCircuit")) {
      case "int":
...
function makeNothingCircuit(env, astNode) {
   switch (compiler(astNode, "makeNohtingCircuit")) {
      case "int":
...
function makeAtomCircuit(env, astNode, sigtable) {
   switch (compiler(astNode, "makeAtomCircuit")) {
      case "int":
...
function makeSuspendCircuit(env, astNode, childCircuit) {
   switch (compiler(astNode, "makeSuspendCircuit")) {
      case "int":
...
function makeAbortNonImmediateCircuit(env, astNode, childCircuit) {
   switch (compiler(astNode, "makeAbortNonImmediateCircuit")) {
...
function makeEmitCircuit(env, astNode, signame) {
   switch (compiler(astNode, "makeEmitCircuit")) {
...
function makeIfCircuit(env, astNode, childCircuits) {
   switch (compiler(astNode, "makeIfCircuit")) {
      case "int":
...
function makeLocalCircuit(env, astNode, sigtable) {
   switch (compiler(astNode, "makeLocalCircuit")) {
      case "int":
