...
ast.Module.prototype.make_circuit = function() {
   ...
   if (child.cinterface.k_matrix[0])
      this.machine.k0 = child.cinterface.k_matrix[0][0] || child.cinterface.k_matrix[0][1];
   if (child.cinterface.k_matrix[1])
      this.machine.k1 = child.cinterface.k_matrix[1][0] || child.cinterface.k_matrix[1][1];
}
