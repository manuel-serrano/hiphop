...
ast.ExpressionNode.prototype.make_expression = function(node,
   ...
   if (this.func || this.args_list.length > 0) {
      test_expr = new net.TestExpressionNet(this, node, "testexpr", this.func,
					    this.args_list);
      for (i in start_nets)
...
function make_abort(ast_node, child_interface) {
   ...
   let and2 = net.make_and(ast_node, ast.Abort, "and2_nsig_and1");
   let and3 = net.make_and(ast_node, ast.Abort, "and3_sig_and1");
