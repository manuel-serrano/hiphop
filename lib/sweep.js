...
/*    Last change :  Thu Jan 16 07:59:40 2025 (serrano)                */
...
function simplifyBooleanExpressionNets(machine) {
   ...
   function simplyBooleanExpressionNet(n) {
      if (n instanceof ActionNet && n.func && n.accessor_list.length === 1) {
...
function sweepNets(machine) {
   ...
   function sweepAnyNet(u) {
	 ...
	 if (u.fanin_list.length === 0) {
      ...
      if (u.fanin_list.length === 0 && !(u instanceof SignalNet)) {
	 if (u.fanout_list.length > 0 && u.fanout_list.every(f => f.dependency)) {
