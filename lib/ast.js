...
function Await(loc, signal_name, test_pre, count) {
...
function Abort(loc, signal_name, test_pre, count, subcircuit) {
...
function LoopEach(loc, signal_name, test_pre, count, subcircuit) {
