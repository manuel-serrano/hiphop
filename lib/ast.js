...
/*    Last change :  Wed Aug  1 11:55:30 2018 (serrano)                */
...
/*---------------------------------------------------------------------*/
function SignalAccessor( signal_name, get_pre, get_value, is_cnt = false ) {
   this.signal_name = signal_name;
...
SignalAccessor.prototype.clone = function() {
   return new SignalAccessor(
      this.signal_name, this.get_pre, this.get_value, this.type );
}
