...
/*    Last change :  Sun Feb 16 15:25:52 2025 (serrano)                */
...
export { setCloneDebug };

let cloneDebug = false;
function setCloneDebug() {
   cloneDebug=true;
}
...
class $Emit extends $ActionNode {
   ...
   clone() {
      const clone = new Emit(this.tag,
			     cloneId(this.id), this.loc, this.nodebug, 
			     this.signame_list,
...
class $Sustain extends $Emit {
   ...
   clone() {
      const clone = new Sustain(this.tag,
				cloneId(this.id), this.loc, this.nodebug, 
				this.signame_list,
				this.func, clone_list(this.accessor_list),
				this.if_func, clone_list(this.if_accessor_list));
...
class $Nothing extends $ASTNode {
   ...
   clone() {
      const clone = new Nothing(this.tag,
				cloneId(this.id), this.loc, this.nodebug);
      clone.machine = this.machine;
      clone.depth = this.depth;
      return clone;
...
class $Pause extends $ASTNode {
   ...
   clone() {
      const clone = new Pause(this.tag,
			      cloneId(this.id), this.loc, this.nodebug);
      clone.machine = this.machine;
      clone.depth = this.depth;
      return clone;
...
class $Trap extends $ASTNode {
   ...
   clone() {
      const clone = new Trap(this.tag,
			     cloneId(this.id), this.loc, 
...
class $Await extends $CountExpressionNode {
   ...
   clone() {
      const clone = new Await(this.tag,
			      cloneId(this.id),
...
class $Module extends $ASTNode {
   ...
   clone() {
      const clone = new Module(this.tag, cloneId(this.id),
			       this.loc, this.name,
...
class $Run extends $ASTNode {
   ...
   clone() {
      const clone = new Run(this.tag,
			    cloneId(this.id), this.loc, this.name, this.nodebug,
			    clone_list(this.sigDeclList), 
...
class $Local extends $ASTNode {
   ...
   //
   clone() {
      if (cloneDebug && this.machine === null) throw new Error("NULL " + this.constructor.name);
      const clone = new Local(this.tag,
			      cloneId(this.id), this.loc, this.nodebug,
                              (this.in_run_context ?
				 this.sigDeclList :
				 clone_list(this.sigDeclList)),
...
class $Abort extends $CountExpressionNode {
   ...
   clone() {
      const clone = new Abort(this.tag,
			      cloneId(this.id), this.loc, this.nodebug, this.func,
...
class $WeakAbort extends $CountExpressionNode {
   ...
   clone() {
      const clone = new WeakAbort(this.tag,
				  cloneId(this.id), this.loc, this.nodebug, 
			    this.func, clone_list(this.accessor_list), 
			    this.immediate,
			    this.func_count, 
...
class $Loop extends $ASTNode {
   ...
   clone() {
      if (cloneDebug && this.machine === null) throw new Error("NULL " + this.constructor.name);
      const clone = new Loop(cloneId(this.id), this.loc, this.nodebug,
			     this.clone_children());
      clone.machine = this.machine;
      clone.depth = this.depth;
      return clone;
...
class $LoopEach extends $CountExpressionNode {
   ...
   clone() {
      const clone = new LoopEach(this.tag,
				 cloneId(this.id), this.loc, this.nodebug, 
				 this.clone_children(),
				 this.func, clone_list(this.accessor_list),
				 this.func_count, 
...
class $Every extends $CountExpressionNode {
   ...
   clone() {
      const clone = new Every(this.tag,
			      cloneId(this.id), this.loc, this.nodebug, 
			      this.clone_children(),
			      this.func, clone_list(this.accessor_list), 
			      this.immediate,
...
class $Suspend extends $ExpressionNode {
   ...
   clone() {
      const clone = new Suspend(this.tag,
				cloneId(this.id), this.loc, this.nodebug, 
				this.clone_children(),
				this.func, clone_list(this.accessor_list),
				this.immediate);
...
class $Fork extends $ASTNode {
   ...
   clone() {
      const clone = new Fork(this.tag, cloneId(this.id), this.loc, 
...
class $If extends $ExpressionNode {
   ...
   clone() {
      if (cloneDebug && this.machine === null) throw new Error("NULL " + this.constructor.name);
      const clone = new If(this.tag, cloneId(this.id), this.loc, 
			   this.nodebug, this.clone_children(),
...
class $Sequence extends $ASTNode {
   ...
   clone() {
      if (cloneDebug && this.machine === null) throw new Error("NULL " + this.constructor.name);
      const clone = new Sequence(this.tag,
				 cloneId(this.id), this.loc, this.nodebug, 
				 this.clone_children());
      clone.machine = this.machine;
      clone.depth = this.depth;
...
class SignalProperties {
   ...
   clone() {
      const clone = new SignalProperties(cloneId(this.id), this.loc, this.name,
