...
function WeakAbort(id, loc, nodebug, func, accessor_list, immediate,
   ...
   let c = new Trap(null, loc, true, trap_name, new Parallel(null, loc, true, [
   ...
   CountExpressionNode.call(this, id, loc, nodebug, c, func, accessor_list,
			    immediate, func_count, accessor_list_count);
}
...
Parallel.prototype.appendChild = function(ast_node, oneshot_reg=true) {
   ...
   if (this.machine.react_in_progress) {
      this.machine.update_queue.push(() => this.appendChild(ast_node, oneshot_reg));
      return;
   }
...
Parallel.prototype.removeChild = function(ast_node) {
   if (this.machine.react_in_progress) {
      this.machine.update_queue.push(() => this.removeChild(ast_node));
      return;
   }
