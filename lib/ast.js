...
/*    Last change :  Mon Feb 17 14:47:37 2025 (serrano)                */
...
class $ASTNode {
   ...
   setMachine(machine) {
      ...
      this.children.forEach(c => c.setMachine(machine));
      return this;
   }
}
...
class $Halt extends $ASTNode {
   ...
   clone() {
      return new Halt(this.tag, cloneId(this.id), this.loc, this.nodebug);
   }
}
...
class $Loop extends $ASTNode {
   ...
   clone() {
      return new Loop(cloneId(this.id), this.loc, this.nodebug,
		      this.clone_children());
   }
}
...
class $Fork extends $ASTNode {
   ...
   clone() {
      return new Fork(this.tag, cloneId(this.id), this.loc, 
...
class $If extends $ExpressionNode {
   ...
   clone() {
      return new If(this.tag, cloneId(this.id), this.loc, 
		    this.nodebug, this.clone_children(),
...
/*    computeNodeDepth ...                                             */
/*---------------------------------------------------------------------*/
function computeNodeDepth(ast_node, depth, in_loop) {
