...
___DEFINE_INHERITANCE___(ASTNode, ActionNode);
...
function ExpressionNode(id, loc, children, func, args_list, immediate) {
   ASTNode.call(this, id, loc, children, func, args_list);
...
___DEFINE_INHERITANCE___(ActionNode, Emit);
...
___DEFINE_INHERITANCE___(Emit, Sustain);
...
function Atom(id, loc, func, args_list) {
   ExpressionNode.call(this, id, loc, undefined, func, args_list);
}

___DEFINE_INHERITANCE___(ActionNode, Atom);
...
function Await(id, loc, immediate, func, args_list, immediate, func_count,
	       args_list_count) {
...
function LoopEach(id, loc, children, func, args_list, immediate, func_count,
		  args_list_count) {
   CountExpressionNode.call(this, id, loc, children, func, immediate, args_list,
			    func_count, args_list_count);
}

___DEFINE_INHERITANCE___(CountExpressionNode, LoopEach);
...
___DEFINE_INHERITANCE___(CountExpressionNode, Every);
...
___DEFINE_INHERITANCE___(ExpressionNode, Suspend);
