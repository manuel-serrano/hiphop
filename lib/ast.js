...
Atom.prototype.factory = function() {
   return new rk.Atom(this.machine, this.id, this.loc, this.func, this.exprs);
}
exports.Atom = Atom;
...
function Run(id, loc, runnable_machine, sigs_assoc) {
   ...
   Circuit.call(this, id, "RUN", loc, this.runnable_ast);
...
Run.prototype.factory = function() {
   this.runnable_machine.machine_dst = this.machine;
