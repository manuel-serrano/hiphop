...
/*    Last change :  Thu Aug  2 14:58:21 2018 (serrano)                */
...
exports.Promise = function( self, promise ) {
   promise
      .then( v => self.terminateExecAndReact( { resolve: true, val: v } ),
	     v => self.terminateExecAndReact( { resolve: false, val: v } ) );
}
