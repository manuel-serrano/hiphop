...
/*    Last change :  Wed Jul 15 11:33:37 2026 (serrano)                */
...
/*    Debug                                                            */
/*---------------------------------------------------------------------*/
const DEBUG = config.Process.env.HIPHOP_TRACE?.split(",")?.find?.(n => n === "uncycle"); 
...
function uncycle(machine) {
   ...
   const userCycle = config.Process.env.HIPHOP_UNCYCLE_NETS?.split(",")
