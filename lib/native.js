...
/*    Last change :  Wed Nov 19 08:24:00 2025 (serrano)                */
...
function compileJS(mach) {
   ...
   if (DEBUG) {
      ...
      console.log('');
      console.log(`NODE_OPTIONS="${process.env?.NODE_OPTIONS ?? "--enable-source-maps --no-warnings --loader @hop/hiphop/lib/hiphop-loader.mjs"}" IPHOP_DEBUG_NATIVE_SOURCE="/tmp/native.mjs" ${process.argv.join(" ")}`);
