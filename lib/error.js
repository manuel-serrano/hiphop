...
function TrapError(msg, trap_name, loc) {
   HipHopError.call(this, "TRAP ERROR on trap `" + trap_name + "`",
		    msg, loc);
}

TrapError.prototype = new HipHopError(undefined, undefined, undefined);
...
// function CyclicError(loc, signal_name) {
//    HipHopError.call(this, "CYCLIC ERROR", "on signal " + signal_name, loc);
// }

// CyclicError.prototype = new HipHopError(undefined, undefined, undefined);

// exports.CyclicError = CyclicError;
