...
/*    Last change :  Thu Mar 12 09:52:13 2026 (serrano)                */
...
function makeForkCircuit(env, astNode, childCircuits) {
   ...
   childCircuits.forEach((c, n, _) => {
      ...
      if (forceOldSynchronizer) {
	 // this schema is wrong, it is preserved in the compiler code
	 // only for illustrating the error of the Fig 11.10
	 // 
	 // With this schema, the following program is not executed correctly:
	 // 
	 // loop {
	 //    fork {
	 //       yield;
