...
ast.ASTNode.prototype._dump = function(dump_ctx, indent) {
   ...
   let isFork = this instanceof ast.Parallel;
...
ast.Parallel.prototype._dump_word_list = function() {
...
ast.Exec.prototype._dump_word_list = function() {
   ...
   if (this.signal) {
	 ...
	 if (this.signal.gate_list[i].value == true) {
      ...
      let w = word_list.add_at(1, this.signal_name, DISP_FG_SIGNAL(present));
      w.signal_value = v instanceof Object ? v.toString() : v;
