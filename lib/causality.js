/*=====================================================================*/
/*    serrano/prgm/project/hiphop/1.3.x/lib/causality.js               */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano & Jayanth Krishnamurthy            */
/*    Creation    :  Tue Jul  9 11:59:33 2019                          */
/*    Last change :  Tue Jan 30 08:01:18 2024 (serrano)                */
...
const rl = config.isServer ? await import("@hop/readlines") : {};

export { reportCausalityError, findCausalityError };
