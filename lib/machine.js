...
/*    Last change :  Tue Dec 16 08:56:26 2025 (serrano)                */
...
/*---------------------------------------------------------------------*/
const MachineOpts = [
   "dynamic", "sweep", "sigpre", "unreachable", "compiler", "loopUnroll",
   "native", "loopExpand", "reincarnation", "loopDup", "loopSafe",
   "tracePropagation", "forkOrKill", "traceReactDuration", "dumpNets",
   "causalityErrorTrace", "debuggerName" ];
