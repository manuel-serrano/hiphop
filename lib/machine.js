...
function ReactiveMachine(ast_node, name="") {
   ...
   //
   // TODO: broken (an output signal only must not have setter). Fixit.
   //
   for (let signalName in this.output_signal_map) {
      let signal = this.output_signal_map[signalName];
   ...
   //
   // Generate JS promise for each output signal
   //
   this.promise = {};
   for (let signalName in this.output_signal_map) {
      let signal = this.output_signal_map[signalName];
      ...
      Object.defineProperty(this.promise, signalName, {
	 configurable: false,
	 enumerable: false,
	 get: function() {
	    return new Promise(function(resolve, reject) {
	       machine.addEventListener(signalName, function(evt) {
