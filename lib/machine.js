...
/*    Last change :  Sun Nov 11 02:20:48 2018 (serrano)                */
...
export class ReactiveMachine {
   constructor( ast_node, opts={} ) {
	 ...
	 out[ k ] = undefined;
      ...
      //this.outputProxy = new hop.reactProxy( out );
      this.outputProxy = {};
...
function react( mach ) {
   ...
   let reactReturnValue = mach.outputProxy;
   ...
   for (let i in mach.output_signal_map) {
	 ...
	 reactReturnValue[ sig.name ] = sig.value; 
