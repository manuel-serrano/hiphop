...
ReactiveMachine.prototype.react = function() {
   ...
   if (this._debugger && this._debugger.stepper) {
      this._debugger.react_queue.push({ func: ReactiveMachine.prototype.react });
      return;
   }
...
ReactiveMachine.prototype.input = function(signal, value=undefined) {
   ...
   if (this._debugger && this._debugger.stepper) {
      this._debugger.react_queue.push({ func: ReactiveMachine.prototype.input,
					args: [signal, value] });
      return;
   }
...
ReactiveMachine.prototype.inputAndReact = function(signal, value=undefined) {
   if (this._debugger && this._debugger.stepper) {
      this._debugger.react_queue.push({
	 func: ReactiveMachine.prototype.inputAndReact,
	 args: [signal, value]
      });
      return;
   }
