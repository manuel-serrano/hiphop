...
/*    Last change :  Fri Jun 13 09:22:50 2025 (serrano)                */
...
class ReactiveMachine {
   ...
   constructor(ast_node, opts={}) {
	 ...
	 throw new Error("HipHop, cannot use both dynamic and sweep: " + opts);
      ...
      // unroll loops
      this.unrollLoop = ("unrollLoop" in opts) ? opts.unrollLoop : undefined;
      
      // reincarnation
      this.reincarnation = ("reincarnation" in opts) ? opts.reincarnation : undefined;
      
      // duplicate loops
      this.dupLoop = ("dupLoop" in opts) ? opts.dupLoop : undefined;
