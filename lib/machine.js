...
ReactiveMachine.prototype.recompile = function() {
   compiler.compile(this, this.ast);
   this.reset();
}
...
ReactiveMachine.prototype.restore = function(machine_state) {
   ...
   _restore_signals(this.input_signal_map, machine_state.input_signal_map);
   _restore_signals(this.input_signal_map, machine_state.output_signal_map);
   _restore_signals(this.input_signal_map, machine_state.local_signal_map);
