...
exports.client = [ "reactive-js.js", "reactive-kernel.js", "ast.js",
		   "xml-compiler.js", "compiler.js", "batch-interpreter.js",
		   "pretty-printer.js" ].map(function (obj, i, arr) {
		      return dirname(module.filename) + "/" + obj
		   });

if (this && this.process && process.versions.hop) {
