...
class Exec extends ActionArg {
   ...
   react( input = undefined ) {
      throw 'The function "this.react" is no longer supported inside async form. Use "this.machine.react( sigset )" instead.';
/*       this.machine.reach( input );                                  */
