...
function Signal(name, gate_list, pre_gate) {
   this.name = name;
   this.gate_list = gate_list;
   this.pre_gate = pre_gate;
   this.set_by_host = false;
}

exports.Signal = Signal;

function ValuedSignal(name, gate_list, pre_gate, combine_with, init_value) {
   Signal.call(this, name, gate_list, pre_gate);
