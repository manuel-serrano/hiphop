...
/*    Last change :  Tue Mar 17 07:52:24 2026 (serrano)                */
...
class Signal {
   ...
   constructor(astNode, prop, pre, k1List = null, killList = null, susp = null, depth) {
	 ...
	 if (!this.machine.reincarnation && (depth != 0)) {
	    console.error("SIGNAL: incoherent compilation mode.1", this.machine.name());
	 }
      } else {
	 if (depth === 0 && susp) {
