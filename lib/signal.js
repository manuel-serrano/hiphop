...
Signal.prototype.add_emitter = function(ast, write_value) {
   this.emitters.push({node: ast,
		       write_value: write_value});
}

/* `value` = true => access to the value */
Signal.prototype.add_reader = function(ast, read_value) {
   this.readers.push({node: ast,
