...
/*    Last change :  Tue Apr 14 13:32:40 2026 (serrano)                */
...
/*    outConf ...                                                      */
/*---------------------------------------------------------------------*/
hh.ReactiveMachine.prototype.outConf = function(dir, suffix, {prog, events}) {
   const target = dir + "/x" + this.name() + "y" + suffix + ".hh.mjs";
