...
/*    Last change :  Wed Oct 29 07:49:44 2025 (serrano)                */
...
/*    makeProg ...                                                     */
/*---------------------------------------------------------------------*/
function makeProg(prog, eventsfile) {
   return ";; generated by testrandom\n"
      ...
      + ('\n')
      + (`(let ((events (call-with-input-file "${eventsfile}" read)))\n`)
...
class ReactiveMachine {
   ...
   constructor (prog, opts) {
      this.file = opts?.rktfile || this.#rktfile;
