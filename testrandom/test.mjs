...
export const prop = new Prop(
   ...
   { name: "rocq", ctor: (prg => new rocq.ReactiveMachine(prg, { name: "rocq" })), config: { pre: 0, expr: 0, maxLoop: 3, maxSignals: 5, maxSize: 8 } },
   { name: "rocq-constructive", ctor: (prg => new rocq.ReactiveMachine(prg, { name: "rocq", semantics: "constructive" })), config: { pre: 0, expr: 0, maxLoop: 3, maxSignals: 5, maxSize: 8 } },
   { name: "rocq-state", ctor: (prg => new rocq.ReactiveMachine(prg, { name: "rocq", semantics: "state" })), config: { pre: 0, expr: 0, maxLoop: 3, maxSignals: 5, maxSize: 8 } }
);
